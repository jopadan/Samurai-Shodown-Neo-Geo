...
bool ModuleSceneNakoruru::Start()
{
	...
	musload = App->music->LoadMus(DATADIR "Assets/Sound/Banquet of Nature (Nakoruru).ogg");
	graphics = App->textures->Load(DATADIR "Assets/Image/Nakoruru Map Spritesheet.png");
	font_timer = App->fonts->Load(DATADIR "Ui/UI_Numbers_1.png", "9876543210", 1);
	end = App->music->LoadChunk(DATADIR "Assets/Sound/Referee/Samurai Shodown - Referee - end.wav");
	ippon = App->music->LoadChunk(DATADIR "Assets/Sound/Referee/Samurai Shodown - Referee - ippon.wav");
	starto = App->music->LoadChunk(DATADIR "Assets/Sound/Referee/Samurai Shodown - Referee - Start.wav");
	Round = App->music->LoadChunk(DATADIR "Assets/Sound/Referee/Samurai Shodown - Referee - Round.wav");
...
update_status ModuleSceneNakoruru::Update()
{
	...
	snprintf(timer_text, 10, "%d", timer);

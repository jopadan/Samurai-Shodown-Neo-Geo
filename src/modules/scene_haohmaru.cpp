...
bool ModuleSceneHaohmaru::Start()
{
	...
	musload = App->music->LoadMus(DATADIR "Assets/Sound/Masculine Song -Sun- (Haohmaru).ogg");
	start = App->music->LoadChunk(DATADIR "Assets/Sound/Referee/Samurai Shodown - Referee - Start.wav");
	...
	graphics = App->textures->Load(DATADIR "Assets/Image/haohmaru_stage.png");

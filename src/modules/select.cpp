...
bool ModuleSelect::Start()
{
	...
	musload = App->music->LoadMus(DATADIR "Assets/Sound/Twelve Swordsmen (Player Select).ogg");
	select = App->music->LoadChunk(DATADIR "Assets/Sound/Samurai Shodown - SELECTING IN MENU.wav");
	enter = App->music->LoadChunk(DATADIR "Assets/Sound/Samurai Shodown - Enter in Menu.wav");
	graphics = App->textures->Load(DATADIR "Assets/Image/Select.png");
	player1 = App->textures->Load(DATADIR "Assets/Image/Nakoruru spritesheet.png");
	player2 = App->textures->Load(DATADIR "Assets/Image/Nakoruru spritesheet p2.png");

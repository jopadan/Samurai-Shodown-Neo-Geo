...
update_status ModulePlayer::Update()
{
	...
	{
		App->particles->AddParticle(App->particles->laser, position.x + 93, position.y + 83);
		App->particles->AddParticle(App->particles->laser, position.x + 62, position.y + 52);
		App->particles->AddParticle(App->particles->laser, position.x + 31, position.y + 21);
		App->particles->AddParticle(App->particles->laser, position.x + 31, position.y - 21);
		App->particles->AddParticle(App->particles->laser, position.x + 62, position.y - 52);
		App->particles->AddParticle(App->particles->laser, position.x + 93, position.y - 83);
	}
